...
namespace CountryCityApp.Controllers
{
    public class CountryController : Controller
    {
        ...
        {
            var matchedArticle = db.Countries.Where(a => a.Name.Contains(text)).ToList();
            return View(matchedArticle);
        }
        //[HttpPost]
        //public ActionResult Search(string countryName)
        //{
        //    var matchedArticle = db.Countries.Where(a => a.Name.Contains(countryName)).ToList();
        //    return View(matchedArticle);
        //}
